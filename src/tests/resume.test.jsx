...
describe('Resume', () => {
  ...
  it('lists key roles, summary, and professional skills', () => {
    ...
    expect(screen.getByText(/jiffy lube/i)).toBeInTheDocument()
    expect(screen.getByText(/autozone/i)).toBeInTheDocument()
    expect(screen.getByText(/jewel-osco/i)).toBeInTheDocument()
